...
public class Tablica {
    ...
    public static Object dohvati (Class cls, int id) throws Exception{
        ...
        if(rezultat.next()){
            ...
            throw new Exception("Entitet s tim IDem ne postoji.");
        }
    }
    ...
    public void spasi() throws Exception {
        ...
        INSERT_SQL_UPIT.append(")");
        PreparedStatement upit =Baza.KONEKCIJA.prepareStatement(INSERT_SQL_UPIT.toString(), Statement.RETURN_GENERATED_KEYS);
